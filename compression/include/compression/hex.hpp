...
/**
   @class hex_view compression/hex.hpp
...
private:
    ...
    /** @brief if true also print ascii encoding (for printable codes), \c ? otherwise.  @see hex::with_char **/
    bool as_text_;
};
